...
class Friend:
    ...
    def get_all(cls):
        ...
        results = connect_to_mysql('crud2').query_db(query)
    ...
    def save(cls, data):
        ...
        return connect_to_mysql('crud2').query_db(query, data)
    ...
    @classmethod
    def update(cls, data):
        query = """UPDATE friends SET first_name=%(first_name)s, last_name=%(last_name)s, email=%(email)s, created_at=NOW(), 
